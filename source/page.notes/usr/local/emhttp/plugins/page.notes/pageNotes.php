...
<textarea id='UnraidNotes' style='font-family:Courier New; width:90%; margin-left:5%' rows=20 placeholder='Enter Notes Here' oninput='$("#saveButton").prop("disabled",false);'></textarea>
<center>
